(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.mdDateTimePicker = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
},{"get-size":4,"unidragger":6}],2:[function(require,module,exports){
'use strict';
 ...
 */
	function mdDateTimePicker(_ref) {
		...
		var init = _ref$init === undefined ? (0, _moment2.default)() : _ref$init;
		var _ref$past = _ref.past;
		var past = _ref$past === undefined ? (0, _moment2.default)().subtract(21, 'years') : _ref$past;
		var _ref$future = _ref.future;
		var future = _ref$future === undefined ? init : _ref$future;
		var _ref$mode = _ref.mode;
		var mode = _ref$mode === undefined ? false : _ref$mode;
		var _ref$orientation = _ref.orientation;
		var orientation = _ref$orientation === undefined ? 'LANDSCAPE' : _ref$orientation;
		var _ref$trigger = _ref.trigger;
		var trigger = _ref$trigger === undefined ? '' : _ref$trigger;
		var _ref$ok = _ref.ok;
		var ok = _ref$ok === undefined ? 'ok' : _ref$ok;
		var _ref$cancel = _ref.cancel;
		var cancel = _ref$cancel === undefined ? 'cancel' : _ref$cancel;
		var _ref$colon = _ref.colon;
		var colon = _ref$colon === undefined ? true : _ref$colon;
 ...
 */
  ...
  */
		...
		value: function _switchToTimeView(me) {
			...
			var circularHolder = me._sDialog.circularHolder;
			var circle = me._sDialog.circle;
			var fakeNeedle = me._sDialog.fakeNeedle;
			var spoke = 60;
			var value = void 0;
			// toggle view classes
...
},{"./draggabilly":1,"moment":5}],3:[function(require,module,exports){
/**
 * EvEmitter v1.0.3
 * Lil' event emitter
 * MIT License
...
},{"unipointer":7}],7:[function(require,module,exports){
/*!
 * Unipointer v2.1.0
